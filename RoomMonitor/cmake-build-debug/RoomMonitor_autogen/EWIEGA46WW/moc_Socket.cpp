...
QT_MOC_LITERAL(3, 16, 9), // "nSchedine"
QT_MOC_LITERAL(4, 26, 7), // "stopped"
QT_MOC_LITERAL(5, 34, 13) // "newConnection"

    },
    "Socket\0started\0\0nSchedine\0stopped\0"
    "newConnection"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Socket::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::started)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::stopped)) {
                *result = 1;
                return;
            }
        }
