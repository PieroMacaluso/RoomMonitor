...
const QString Query::SELECT_MAC_TIMING_AVGPOS = "SELECT mac_addr, timing, pos_x, pos_y\n"
                                                "FROM (SELECT mac_addr,\n"
                                                ...
                                                "      ORDER BY timing) as aa\n"
                                                "WHERE pos_x >= 0\n"
                                                "  AND pos_y >= 0\n"
                                                "  AND pos_x <= :lar\n"
                                                "  AND pos_y <= :lun;";
const QString Query::SELECT_MAC_TIMING_AVGPOS_SINGLE = "SELECT mac_addr, timing, pos_x, pos_y\n"
                                                       "FROM (SELECT mac_addr,\n"
...
const QString Query::SELECT_MAC_TIMING_LASTPOS = "SELECT mac_addr, timing, pos_x, pos_y\n"
                                                 "FROM (SELECT mac_addr, timing, pos_x, pos_y\n"
                                                 ...
                                                 "      ORDER BY mac_addr, timestamp DESC) as s\n"
                                                 "WHERE pos_x >= 0\n"
                                                 "  AND pos_y >= 0\n"
                                                 "  AND pos_x <= :lar\n"
                                                 "  AND pos_y <= :lun;";
