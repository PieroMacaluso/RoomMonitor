...
const QString Strings::ERR_DB_MSG = Strings::tr("Si è verificato un errore con il database, ti invitiamo a modificare le impostazioni e riprovare.");
...
const QString Strings::RANGE_ERROR_MSG = Strings::tr("La data di inizio deve essere antecedente alla data di fine.\nLa loro differenza deve essere maggiore o uguale a 5 minuti.");
const QString Strings::ANA_RUNNING = Strings::tr("Errore selezione range");
const QString Strings::ANA_RUNNING_MSG = Strings::tr("La data di inizio deve essere antecedente alla data di fine.\nLa loro differenza deve essere maggiore o uguale a 5 minuti.");
